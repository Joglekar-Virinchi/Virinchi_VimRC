" Octave indent file
" Language:	Octave
" Maintainer:	Christophe Poucet <christophe.poucet@...>
" Last Change:	6 January, 2001
"
" add some Octave stuff:	19 April 2009 <alain.baeckeroot@...>
...
setlocal indentkeys=!,o,O=end,=case,=else,=elseif,=otherwise,=catch,=endfor,=endwhile,=until,=endfunction
...
function GetOctaveIndent(lnum)
  ...
  if getline(v:lnum) =~ '^\s*\(end\|endfor\|endwhile\|endif\|until\|endfunction\|else\|elseif\|case\|otherwise\|catch\)\>'
